...
function grainno_floating_cart_html() {
    ...
    <div id="gf-floating-cart" class="<?php echo $count > 0 ? 'has-items' : ''; ?>">
        <button class="gf-cart-toggle" id="gf-cart-toggle" aria-label="Open cart">
            ...
            <?php if ($count > 0) : ?>
                <span class="gf-cart-count"><?php echo $count; ?></span>
            <?php endif; ?>
        </button>
            ...
            <?php if ($count > 0) : ?>
                <div class="gf-cart-panel__footer">
                    <div class="gf-cart-panel__total">
                        <span>Total</span>
                        <span class="amt">₦<?php echo number_format($total, 0, '.', ','); ?></span>
                    </div>
                    <a href="<?php echo esc_url($wa_url); ?>" class="gf-wa-btn" id="gf-wa-btn" target="_blank" rel="noopener">
                    ...
                    <a href="<?php echo esc_url(wc_get_cart_url()); ?>" style="display:block;text-align:center;margin-top:10px;font-size:0.82rem;color:rgba(253,250,245,0.4);">View full cart →</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
